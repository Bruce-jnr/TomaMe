...
app.use('/api/v1/auth/password-reset/request', rateLimit({ windowMs: 15 * 60_000, limit: 5, handler: authRateLimitHandler }));
app.use('/api/v1/auth/password-reset/confirm', rateLimit({ windowMs: 15 * 60_000, limit: 8, handler: authRateLimitHandler }));
